...
4. **Set Redirect URLs:**
   - Add: `https://enterprise-video.preview.emergentagent.com/api/linkedin/callback`
...
2. **Get Credentials:**
   ...
   - Set OAuth 2 redirect: `https://enterprise-video.preview.emergentagent.com/api/cloud/dropbox/callback`
...
1. **Register Azure App:**
   ...
   - Name: "MedMatch Integration"
   - Redirect URI: `https://enterprise-video.preview.emergentagent.com/api/cloud/onedrive/callback`
