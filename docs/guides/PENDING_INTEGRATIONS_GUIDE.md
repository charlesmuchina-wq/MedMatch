...
4. **Set Redirect URLs:**
   - Add: `https://ai-tts-portal.preview.emergentagent.com/api/linkedin/callback`
...
2. **Get Credentials:**
   ...
   - Set OAuth 2 redirect: `https://ai-tts-portal.preview.emergentagent.com/api/cloud/dropbox/callback`
...
1. **Register Azure App:**
   ...
   - Name: "MedMatch Integration"
   - Redirect URI: `https://ai-tts-portal.preview.emergentagent.com/api/cloud/onedrive/callback`
