...
4. **Set Redirect URLs:**
   - Add: `https://distance-zero-replay.preview.emergentagent.com/api/linkedin/callback`
...
2. **Get Credentials:**
   ...
   - Set OAuth 2 redirect: `https://distance-zero-replay.preview.emergentagent.com/api/cloud/dropbox/callback`
...
1. **Register Azure App:**
   ...
   - Name: "MedMatch Integration"
   - Redirect URI: `https://distance-zero-replay.preview.emergentagent.com/api/cloud/onedrive/callback`
