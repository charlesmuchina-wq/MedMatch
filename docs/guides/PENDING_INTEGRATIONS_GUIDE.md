...
4. **Set Redirect URLs:**
   - Add: `https://medmatch-jobs-dev.preview.emergentagent.com/api/linkedin/callback`
...
2. **Get Credentials:**
   ...
   - Set OAuth 2 redirect: `https://medmatch-jobs-dev.preview.emergentagent.com/api/cloud/dropbox/callback`
...
1. **Register Azure App:**
   ...
   - Name: "MedMatch Integration"
   - Redirect URI: `https://medmatch-jobs-dev.preview.emergentagent.com/api/cloud/onedrive/callback`
