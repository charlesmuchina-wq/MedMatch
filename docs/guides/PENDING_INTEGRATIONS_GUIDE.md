...
4. **Set Redirect URLs:**
   - Add: `https://karau-enzi-nexus.preview.emergentagent.com/api/linkedin/callback`
...
2. **Get Credentials:**
   ...
   - Set OAuth 2 redirect: `https://karau-enzi-nexus.preview.emergentagent.com/api/cloud/dropbox/callback`
...
1. **Register Azure App:**
   ...
   - Name: "MedMatch Integration"
   - Redirect URI: `https://karau-enzi-nexus.preview.emergentagent.com/api/cloud/onedrive/callback`
