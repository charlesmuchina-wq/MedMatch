...
- **AI Meeting Coach** (Mar 1, 2026): Real-time private coaching tips for presenters. Categories: engagement, pacing, clarity, energy, interaction, time_management. Urgency: low/medium/high. Post-meeting coaching report with improvement areas

### Immersive Meeting Features
- **Eye-Contact Correction**: CSS perspective transform on local video feed to simulate direct eye contact
- **Enhanced Digital Whiteboard**: Infinite canvas with pen, rectangle, circle, text, sticky notes, eraser. Zoom/pan, undo/redo, PNG export, grid background
...
## Backlog
### P1
- Virtual breakout lounges, interactive challenges/gamification
### P2
