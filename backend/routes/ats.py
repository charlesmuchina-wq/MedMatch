...
async def create_application_link(data: ApplicationLinkCreate, request: Request):
    ...
    app_url = "https://karau-enzi-nexus.preview.emergentagent.com"
...
async def submit_external_application(
    ...
    return {
        ...
        "application_id": application_id,
        "tracking_token": tracking_token,
        "tracking_url": f"https://karau-enzi-nexus.preview.emergentagent.com/track-application/{application_id}?token={tracking_token}"
    }
...
async def invite_candidate_to_apply(
    ...
    application_url = f"https://karau-enzi-nexus.preview.emergentagent.com/apply/{link_token}"
