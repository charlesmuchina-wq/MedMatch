...
class TestPaymentFlow:
    ...
    def test_stripe_checkout_session_creation(self):
        ...
        payload = {
            "success_url": "https://karau-meet.preview.emergentagent.com/membership?success=true",
            "cancel_url": "https://karau-meet.preview.emergentagent.com/membership?canceled=true",
            "plan": "lifetime"
        }
    ...
    def test_paypal_payment_creation(self):
        ...
        payload = {
            "success_url": "https://karau-meet.preview.emergentagent.com/membership?provider=paypal&success=true",
            "cancel_url": "https://karau-meet.preview.emergentagent.com/membership?canceled=true",
            "plan": "lifetime"
        }
