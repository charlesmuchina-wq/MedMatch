...
Usage:
    pip install locust
    locust -f stress_test_locust.py --host=https://lseng-talent-hub.preview.emergentagent.com
...
Or for headless:
    locust -f stress_test_locust.py --host=https://lseng-talent-hub.preview.emergentagent.com --headless -u 100 -r 10 -t 5m
