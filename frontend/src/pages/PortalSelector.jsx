          ...
          {portals.map((portal) => (
            ...
            >
              ...
              <div className="relative p-6 sm:p-8">
                ...
                {/* Description */}
                <p className="text-slate-300 text-sm sm:text-base mb-4 sm:mb-6 min-h-[40px] sm:min-h-[48px]">
                  {portal.description}
                </p>
                ...
                <div className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                  {portal.features.map((feature, idx) => (
                    <div 
                      key={idx} 
                      className="feature-item flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-400"
                    >
                      <div className={`
                      ...
                      `}>
                        <feature.icon className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-300" />
                      </div>
