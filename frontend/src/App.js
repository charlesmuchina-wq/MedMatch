...
import TeamOutreachPage from "@/pages/TeamOutreachPage";
...
const Sidebar = ({ isOpen, setIsOpen, user }) => {
  ...
  const recruiterLinks = [
    ...
    { path: "/team-outreach", icon: MessageSquare, labelKey: "Team & Outreach" },
    { path: "/offer-management", icon: FileCheck, labelKey: "Offers" },
    { path: "/semantic-search", icon: UserSearch, labelKey: "AI Search" },
    { path: "/report-builder", icon: Code, labelKey: "Report Builder" },
